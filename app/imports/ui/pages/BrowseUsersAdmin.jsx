    ...
    return (
      <div className='music-background'>
        <Container>
          ...
          />
          <Header as="h2" textAlign="center" inverted>Browse Users (Admin)</Header>
          <Card.Group centered>
            <Card>
              <Card.Content>
            ...
            <Card>
              ...
              <Card.Content extra>
                <Link className='admin-link' to="/ViewProfile">View</Link>
                <Link className='admin-link' to="/ViewProfile">Edit</Link>
                <Link className='admin-link' to="/ViewProfile">Delete</Link>
              </Card.Content>
            </Card>
...
export default withRouter(BrowseUsersAdmin);
