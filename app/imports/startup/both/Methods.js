 ...
 */
Meteor.methods({
  'Profiles.update'({ email, name, address, image, goals, phone, interests, instruments }) {
    Profiles.collection.update({ email }, { $set: { name, address, image, goals, phone, instruments } });
